...
function hoot_theme_appearance_subpage() {
	...
	$plinklabeltop = ( !empty( $hoot_premium_cta_labeltop ) ) ? $hoot_premium_cta_labeltop : __( 'Click here to know more', 'responsive-brix' );
	$plinklabelbottom = ( !empty( $hoot_premium_cta_labelbottom ) ) ? $hoot_premium_cta_labelbottom : __( 'Buy Now', 'responsive-brix' );
	$plinklabeldemo = ( !empty( $hoot_premium_cta_labeldemo ) ) ? $hoot_premium_cta_labeldemo : __( 'View Demo Site', 'responsive-brix' );
